...
| `origin-apps` | [Origin Apps](origin-apps/) | Cursor | Developer Tools | Plan the port of an existing GitHub App to a Cursor Origin App: discover its GitHub surface, map it onto the live Origin API, write a porting brief. |
